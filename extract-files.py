...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/libvendor.goodix.hardware.biometrics.fingerprint@2.1.so', 'vendor/lib64/vendor.silead.hardware.fingerprintext@1.0.so', 'vendor/lib64/vendor.silead.hardware.fingerprintext@1.0-adapter-helper.so'): blob_fixup()
